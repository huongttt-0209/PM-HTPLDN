...
| BUG-FR22-003 | Minor | FR-VIII-22 line 1074-1079 (E1-E6) | errCode mismatch — BE dùng `ERR-VAL-VIII-22-XX` / `ERR-VAL-SYS-00-XX` thay SRS `ERR-REG-XX` | ✅ Closed-verified 2026-05-10 (BE đổi → 409 + `ERR-REG-01`) |
| BUG-FR22-004 | Medium | FR-VIII-22 line 1032 | BE thêm validation MST checksum theo TT 105/2020 — KHÔNG có trong SRS spec; cần BA confirm bổ sung hay drop | ✅ Closed-verified 2026-05-10 (BE drop checksum, MST `1234567890` → 201) |
| BUG-FR22-005 | Minor | FR-VIII-22 §Error Handling | BE warning WRN-DN-01 quy mô-lao động (NĐ 39/2018) — KHÔNG có trong FR-VIII-22 §Error Handling; cần BA confirm | ✅ Closed-verified 2026-05-10 (BE drop rule, quy mô NHO + lao động=0 → 201) |

**Bug file riêng:** [Pass-bug-report-function-r7-7-8b-self-reg-dn.md](../../bug-reports/qtht-tai-khoan/Pass-bug-report-function-r7-7-8b-self-reg-dn.md)
