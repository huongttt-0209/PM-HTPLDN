...
| **BM-041** | UC95 | Switch OFF default + 3 fields ẨN khỏi form | 🚫 | ⚠️ | Switch OFF default ✓ (`aria-checked=false`). **3 trường (Ảnh đại diện / Mô tả công khai / File đính kèm công khai) VẪN visible khi Switch OFF** → vi phạm spec BM-041 + line 147. → **[BUG-BM-010](../../bug-reports/bm/bug-report-function-bm-r7-7-10.md#bug-bm-010--form-thêm-bm-3-trường-công-khai-visible-khi-switch-off-vi-phạm-bm-041) (Medium, mới)**. |
