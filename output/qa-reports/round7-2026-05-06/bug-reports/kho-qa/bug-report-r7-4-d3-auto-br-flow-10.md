...
|--------|----------|----------|------|--------|-------------------|-------|--------|
| BUG-KHOQA-AUTO-001 | Major | P1 | Workflow | R7.4.D3.AUTO | `02-thu-tu-module.md` L781 (FR-13 BR-FLOW-10) · L509 (SM-HOIDAP hook) | BE không auto tạo Kho QA `nguon=TU_DONG` khi HD chuyển `DA_DUYET` | Open |

---

## BUG-KHOQA-AUTO-001 — BE không auto tạo Kho QA TU_DONG khi HD chuyển DA_DUYET

> **Re-test:** 2026-05-10 12:21:48 R10c — ❌ **FAIL (vẫn Open)** — Dev claim đã fix nhưng verify lại trên fresh HD-20260510-001 (lifecycle full MOI→TIEP_NHAN→DANG_XU_LY→CHO_PHE_DUYET→DA_DUYET hoàn tất qua UI `cb_nv_tw_08` + `cb_pd_tw_08`, ngày duyệt 2026-05-10T05:21:48Z). Sau APPROVE + chờ 30s, pool Kho QA giữ 14 records, `nguon=TU_DONG` count = 0, `khoCauHoiId` field trên HD = `null`. BE chưa hề trigger BR-FLOW-10. HD-20260509-010 cũ (DA_DUYET 16h trước) cũng không spawn retroactive.
...
**Re-test R10c 2026-05-10 12:21:48 — fresh HD-20260510-001:**
...
**Re-test R10c 2026-05-10 12:21:48 — fresh lifecycle:**
