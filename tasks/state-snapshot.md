...
| **TAI_KHOAN R7.7.8a** | `/api/v1/tai-khoan` | **89** | HOAT_DONG:37 / CHO_KICH_HOAT:52 / TAM_KHOA:0 / VO_HIEU_HOA:0 / CHO_PHAN_QUYEN:0. SCR-VIII-08 6 tabs render đúng. BUG-TK-SM-002/003 closed-verified persist (BE counter reset OK + tab Vô hiệu hóa visible). R7.7.8a ✅ re-verify 2026-05-09 00:55. | `.../tai-khoan?pageSize=100` |
