...
- ⚠️ **R7.7.10** ✏️ Biểu mẫu v3.5 — 47 TC (7 cũ + 10 CR-01 + 30 CRUD/workflow) `[~66% — 31/47 PASS, 6 PARTIAL, 5 ⏳ Pending, 5 DEFER]` <a id="r7-7-10"></a>
  ...
  - **Bug:** [bug-report-function-bm-r7-7-10.md](../output/qa-reports/round7-2026-05-06/bug-reports/bm/bug-report-function-bm-r7-7-10.md) — 2/3 đóng (BUG-BM-007/008 closed R8 lần 8 · BUG-BM-010 Medium new — 3 trường công khai visible khi Switch OFF, vi phạm BM-041). Workflow bugs riêng tại [Pass-bug-report-flow-bm-r7-4-c1.md](../output/qa-reports/round7-2026-05-06/bug-reports/bm/Pass-bug-report-flow-bm-r7-4-c1.md) (6/6 đóng R8 lần 7).
