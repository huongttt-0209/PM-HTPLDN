...
- ⚠️ **R7.7.2** ✏️ Functional CG/TVV — 33 TC (28 ID + 5 sub) `[~97% — 32/33 PASS, 1 Open BE rework + BA fix SRS]` <a id="r7-7-2"></a>
  ...
  - **Bug:** [Pass-bug-report-functional-r7-7-2-tvv-retry.md](../output/qa-reports/round7-2026-05-06/bug-reports/tu-van-vien-cg/Pass-bug-report-functional-r7-7-2-tvv-retry.md) — 8/9 đóng. RETRY-005 Open: BE đổi permission "NHT cùng đơn vị" + bỏ endpoint `/nop-lai` riêng + BA fix SRS line 2314.
